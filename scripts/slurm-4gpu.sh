...
accelerate launch  --config_file config-4gpu.yaml --mixed_precision="fp16" --multi_gpu --num_processes $GPUS_PER_NODE /home/nsaeni/Benchmark-DeepLearning-GPU/code/train_text_to_image.py \
